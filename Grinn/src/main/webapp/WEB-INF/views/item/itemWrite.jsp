    ...
    <form:form modelAttribute="itemVO" action="itemWrite.do" id="itemWrite" method="post" enctype="multipart/form-data">
		...
		<ul>
			<li>
				...
				<form:input path="item_brand" placeholder="브랜드명을 입력하세요" autocomplete="off"/><br>
				<form:errors path="item_brand" cssClass="error-color" id="error"/>
			</li>
			<li>
				<form:label path="item_name">이름</form:label>
				<form:input path="item_name" placeholder="상품명을 입력하세요" autocomplete="off"/><br>
				<form:errors path="item_name" cssClass="error-color" id="error"/>
			</li>
			<li>
				<form:label path="item_detail">설명</form:label>
				<form:input path="item_detail" placeholder="상품 설명을 입력하세요" autocomplete="off"/><br>
				<form:errors path="item_detail" cssClass="error-color" id="error"/>
			</li>
			<li>
				<form:label path="item_model">모델명</form:label>
				<form:input path="item_model" placeholder="모델명을 입력하세요" autocomplete="off"/><br>
				<form:errors path="item_model" cssClass="error-color" id="error"/>
			</li>
			<li>
				<form:label path="item_date">출시일</form:label>
				<form:input path="item_date" placeholder="상품 출시일을 입력하세요" autocomplete="off"/><br>
				<form:errors path="item_date" cssClass="error-color" id="error"/>
			</li>
			<li>
			...
			<li>
    			...
    			<form:errors path="item_cate" cssClass="error-color"/>
			</li>
			<li>
    			...
    			<form:errors path="item_gender" cssClass="error-color"/>
			</li>
			<li>
