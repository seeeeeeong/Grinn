...
<c:forEach items="${likedStyles}" var="post">
    <div class="style">
        <div class="style-image">
            ...
            <img src="/user/StyleImageView.do?st_num=${post.st_num}" width="200" height="200" alt="Style Image" style="border-radius: 10px;">
        	</a>
        </div>
        <div class="user-like-section">
            ...
            <div class="user-profile" style="color: rgba(34,34,34,.8); font-size:15px;">
                ...
                <img src="${pageContext.request.contextPath}/user/ProfileImageView.do?st_num=${post.st_num}" width="25" height="25" class="my-photo">
                ${profileId}
            ...
            <div class="like-section">
                <div class="like-button">
                    <img class="output-fav" data-num="${post.st_num}" src="${pageContext.request.contextPath}/images/no_like.png" width="18" height="18">
                </div>
                <span class="output-fcount" data-num="${post.st_num}" style="color: rgba(34,34,34,.5);"></span> 
            </div>
        </div>
