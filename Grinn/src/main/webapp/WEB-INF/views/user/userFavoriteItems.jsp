					...
					<div class="favorite-item bordered-item">
						<a href="/item/itemDetail.do?item_num=${item.item_num}">
							<div class="item-section">
								<img src="/user/itemImageView.do?item_num=${item.item_num}"
						...
						</a> <a href="/purchase/selectSize.do?item_num=${item.item_num}">
							<div class="item-detail2">
								<div class="purchase">구매</div>
								<div class="item-price">
									<fmt:formatNumber value="${item.item_price}" pattern="#,##0원" />
								</div>
							</div>
						</a>
					</div>
