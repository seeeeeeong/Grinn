	...
	$(function(){
		...
		function checking(){
			if($('#check1').is(':checked') && $('#check2').is(':checked') && $('#check4').is(':checked') && $('#check3').is(':checked')){
				...
				$('#btn_purchase').css('background-color','#41B979');
...
<h1 class="align-center">판매 동의</h1>	
<div class="page-size-main">
	<div class="page-check">
		<div class="page-check-inner">
			<div class="check-title">
				<h2><b style="color:#41B979;">판매</b>하시기 전에 꼭 확인하세요.</h2>	
			</div>
			<div class="item">
			...
			<div class="check-purchase">
				...
				<div class="check-button">
					<input type="button" class="btn-continue" id="btn_purchase" value="판매 계속" onclick="location.href='saleDetail.do?item_num=${item_num}&item_size=${item_size}&item_sizenum=${item_sizenum}'">
				</div>
			</div>
		</div>
	</div>
