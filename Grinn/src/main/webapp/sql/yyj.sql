...
(
    CB_ROOMNUM NUMBER NOT NULL,
    MEM_NUM NOT NULL,
    MEM_ID VARCHAR2(12),
    CB_REGDATE DATE DEFAULT SYSDATE,
    CONSTRAINT CHATBOT_PK PRIMARY KEY (CB_ROOMNUM),
...
(
    ...
    MEM_NUM NUMBER NOT NULL,
    MEM_ID VARCHAR2(12),
    CB_QUESTION VARCHAR2(500) NOT NULL,
    CB_ANSWER CLOB,
    CONSTRAINT CROOM_FK1 FOREIGN KEY (CB_ROOMNUM) REFERENCES CHATBOT (CB_ROOMNUM) ON DELETE CASCADE,
